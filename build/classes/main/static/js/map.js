    ...
    var Map = function () {
        ...
        var Timer = function () {
            ...
            var updateVals = function () {
                $('#profile_timer').find('#t_min').html(_min);
                $('#profile_timer').find('#t_sec').html(pad(_sec, 2, '0'));
            };
            ...
            var updateStats = function (data) {
                ...
                $('div.stat_wrapper').each( function () {
                    ...
                    if (stat.stid === 'STAMINA') {
                        clearInterval(_interval);
                        updateTimer(new Date(stat.refill));
                        startTimer();
                    }
            ...
            var init = function () {
                _refill = new Date($('#stat_Stamina').data('refill'));
                _rate = parseInt($('#stat_Stamina').data('rate'));
                updateTimer(_refill);
                startTimer();
            };
        ...
        var attachActions = function () {
            ...
            $('#profile_stats').on('click', '.stats_label.text', function (e) {
                e.preventDefault();
                _timer.replenishStats($(this).html(), 0);
            });
...
/*************************************************/
    var Perks = function () {
        ...
        var init = function () {
            $('.perk_item.unpurchased').on('click', function (e) {
                e.preventDefault();
